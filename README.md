...
Инструмент предназначен для подготовки корпоративных технических заданий и сопутствующей архитектурной документации для системы управления подарочными сертификатами. Проект работает поверх набора директив из `prompt.txt` и автоматизирует создание следующих артефактов:
