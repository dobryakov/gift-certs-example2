...
- Управление жизненным циклом сертификатов: выпуск, фиксация желаемой суммы покупателя для каждого сертификата, активация после полной оплаты заказа, частичное/полное списание, возврат, аннулирование.
- Синхронные операции проверки баланса и списания из фронтов интернет-магазина и POS.
- Автоматическое распределение поступивших платежей по сертификатам в рамках заказа согласно предпочтениям покупателя.
- Поддержка возврата сертификата: инициирование кассиром или покупателем, расчёт полного остатка и запуск возвратного платежа.
...
- Сертификаты в заказе активируются только после полной оплаты всего заказа; частичные платежи аккумулируются и распределяются по сертификатам согласно зафиксированным суммам.
